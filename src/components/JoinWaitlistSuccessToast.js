...
export default function JoinWaitlistSuccessToast({ show, onClose, message }) {
  if (!show) return null;
  return (
    <div className="fixed top-8 right-8 z-[9999]">
      <div className="flex items-center gap-3 bg-green-100 border border-green-400 rounded-2xl px-6 py-4 shadow-lg animate-slide-in-right min-w-[320px] max-w-[400px]">
        ...
        <div className="text-green-800 font-semibold text-base break-words flex-1">
